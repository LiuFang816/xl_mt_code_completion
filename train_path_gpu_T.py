...
def get_model_fn(n_token_N, n_token_T, cutoffs, alpha):
    def model_fn(inpN, inpT, tgtT, inpPath, h_par, mems, is_training):
...
def single_core_graph(n_token_N, n_token_T, cutoffs, is_training, inpN, inpT, tgtT, inputPath, h_par, mems,
                      alpha):
...
def main(unused_argv):
    outfile = 'logs/JAVA_output_mt_T.txt'
    fout = open(outfile, 'a')
