...
def transformer(inpN, inpT, targetsN, targetsT, mems, n_token_N, n_token_T, n_layer, d_model_N, d_model_T, d_embed_N, d_embed_T,
  ...
  with tf.variable_scope(scope):
    ...
    lossT, correct_predictionT = logsoftmax_fn(
        ...
        unk=True)
    return lossN, lossT, new_mems, correct_predictionN, correct_predictionT
